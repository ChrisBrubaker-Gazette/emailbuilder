...
import ContentBlockSidebarPanel from './input-panels/ContentBlockSidebarPanel';
...
import TextEditorBlockSidebarPanel from './input-panels/TextEditorBlockSidebarPanel';
...
export default function ConfigurationPanel() {
  ...
  console.log('ConfigurationPanel Block Data:', {
    selectedBlockId,
    block,
    data: block.data,
    type: block.type
  ...
  switch (type) {
    ...
    case 'ContentBlock':
      return <ContentBlockSidebarPanel key={selectedBlockId} data={data} setData={(data) => setBlock({ type, data })} />;
    case 'Divider':
    ...
    case 'TextEditor':
      return <TextEditorBlockSidebarPanel data={data} setData={(data) => setBlock({ type, data })} />;
    default:
